...
If no Squad Weekly Summary rows exist for this `weekOf` and source = "jira", log `"No rows for week=<weekOf> source=jira"` and exit cleanly — do not create or modify any rows.
