...
If no Squad Weekly Summary rows exist for this `weekOf` and source = "github", log `"No rows for week=<weekOf> source=github"` and exit cleanly — do not create or modify any rows.
